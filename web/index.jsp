...
<html>
    <head>
        ...
        <link rel="stylesheet" href="plugins/MultiNestedList/style.css">
    ...
    <body>
        ...
        <script src="plugins/MultiNestedList/MultiNestedList.js"></script>
        <!--script src="js/d3.v3.min.js" type="text/javascript"></script>
        <script src="js/dndTree.js" type="text/javascript"></script-->
